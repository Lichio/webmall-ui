        ...
        <div class="registered">
          ...
          <div class="content" style="margin-top: 20px;">
            <ul class="common-form">
              <li class="username border-1p">
                <div style="margin-top: 40px;" class="input">
                  <input type="text"
                         v-model="registered.userName" placeholder="手机号"
              ...
              <li>
                <div class="input">
                  <input type="text"
                         v-model="registered.smscode"
                         placeholder="验证码"
                         style="width:70%;">
                  <y-button
                    :classStyle="smsbuttonstatus&&registered.userPwd&&registered.userPwd2&&registered.userName&&smsbuttontxt==='获取验证码'?'main-btn':'disabled-btn'"
                    :text="smsbuttontxt"
                    style="text-align:center;color:#b32929 ;width: 30%;height: 48px;font-size: 12px;"
                    @btnClick="getCode"
                  ></y-button>
                </div>
              </li>
            ...
            <div style="margin-bottom: 30px;">
              <y-button
                :classStyle="registered.smscode&&registered.userPwd&&registered.userPwd2&&registered.userName&&registxt==='注册'?'main-btn':'disabled-btn'"
                :text="registxt"
            ...
            <ul class="common-form pr">
              ...
              <li style="text-align: center;line-height: 48px;margin-bottom: 0;font-size: 12px;color: #999;">
                <span>如果您已拥有 WebMall 账号，则可在此</span>
                <a href="javascript:;"
                   style="margin: 0 5px"
                   @click="toLogin">登陆</a>
              </li>
...
import {register, smscode} from '/api/index.js'
export default {
  data () {
    return {
      cart: [],
      loginPage: true,
      smsbuttonstatus: true,
      ruleForm: {
        userName: '',
        userPwd: '',
        errMsg: ''
  ...
  methods: {
    ...
    regist () {
      ...
      // var smscode = this.registered.smscode
      // var role = 'buyer'
      register(
        {
          username: userName,
    ...
    getCode () {
      let phone = this.registered.userName
      let type = 'register'
