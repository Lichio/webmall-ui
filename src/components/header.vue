        ...
        <div class="w-box">
          <div class="nav-logo">
            <h1 @click="changePage(-1)">
              <router-link to="/" title="WebMall商城官网">WebMall商城</router-link>
            </h1>
          </div>
          <div class="right-box">
            <div class="nav-list">
            ...
            <div class="nav-aside" ref="aside" :class="{fixed:st}">
              ...
              <div class="shop pr" ref="positionMsg">
                <router-link to="/buyer/cart"></router-link>
                <span class="cart-num">
                  <i class="num" :class="cart-num-i">{{''}}</i>
                </span>
                <!--购物车显示块-->
...
export default{
  ...
  methods: {
    ...
    //   },
    toCart () {
      this.$router.push({path: '/buyer/cart'})
    },
    // 控制顶部
    navFixed () {
  ...
  .shop {
    ...
    .cart-num {
      ...
      > i {
        ...
        box-shadow: inset 0 0 1px hsla(0, 0%, 100%, .15), 0 1px 2px hsla(14, 14%, 14%, .15);
        text-align: center;
        font-style: normal;
